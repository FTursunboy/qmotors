<x-dashboard.filter-form>
    ...
    <x-dashboard.form-select label="Пользователи" name="user_phone" option="phone_number" :options="$users" />
    <x-dashboard.form-input label="ВИН" name="vin" :value="request('vin')" />
    <x-dashboard.form-range-input label="Год" name="year" type="number" :value="request('year')" />
    <x-dashboard.form-range-input label="Пробег" name="mileage" type="number" :value="request('mileage')" />
