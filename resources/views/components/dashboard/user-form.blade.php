...
<div class="row">
    ...
    <x-dashboard.form-input name="patronymic" label="Очество" class="col-md-6" :value="$model->patronymic" />
    ...
    <x-dashboard.form-input type="date" name="birthday" label="Дата рождение" class="col-md-6"
