...
<div class="row">
  ...
  <x-dashboard.form-select name="user_car_id" label="Автомобиль" option="title" :options="$user_cars" class="col-md-6"
    :value="$model->user_car_id" required />
  {{-- <x-dashboard.user-car-select class="col-md-6" required /> --}}
  ...
  <x-dashboard.form-select name="order_type_id" label="Тип Заказа" option="name" :options="$orderTypes" class="col-md-6"
  ...
  <x-dashboard.form-switcher name="guarantee" label="Запрос по гарантии" class="col-md-6" :value="$model->guarantee" />
