...
<div class="row">
    ...
    <x-dashboard.form-input name="title" label="Название" class="col-md-12" :value="$model->title"/>
    ...
    <x-dashboard.form-input name="burn_date" type="date" label="Дейсвителен до" class="col-md-6"
                            :value="$model->burn_date"/>
