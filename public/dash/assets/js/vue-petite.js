...
class vt {
    ...
    stop() {
        this.active &&
            (Oe(this), this.onStop && this.onStop(), (this.active = !1));
    }
}
function Oe(e) {
    const { deps: t } = e;
...
function Ct(e = !1) {
    return function (n, s, r, i) {
        ...
        return (
            n === j(i) &&
                (o ? gt(r, c) && se(n, "set", s, r) : se(n, "add", s, r)),
            l
        );
    };
}
...
const q = [],
    ...
    ze = (e) =>
        e == null ? "" : S(e) ? JSON.stringify(e, null, 2) : String(e),
...
class ue {
        ...
        if (this.isFragment) {
            if (this.start) {
                ...
                for (
                    ;
                    s &&
                    ((r = s.nextSibling), t.insertBefore(s, n), s !== this.end);
    ...
    remove() {
        if ((this.parentCtx && ft(this.parentCtx.blocks, this), this.start)) {
            ...
            for (
                ;
                n && ((s = n.nextSibling), t.removeChild(n), n !== this.end);
